...
if($_POST && isset($_POST['name'],$_POST['password'])) {   
    ...
    $sql2 = "SELECT UID from users WHERE email = '$name' and password = '$password'";
    ...
    <body>
        <div class="center">
            ...
            <form method="post">
                ...
                <div class="signup" style="text-align: left;">Not a user? <a href="selector.php">Click here.</a></div>
